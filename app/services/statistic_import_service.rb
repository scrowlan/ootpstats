class StatisticImportService
  ...
  def call(file, tournament_tier_id, tourneydate)
    ...
    CSV.foreach(opened_file, **options) do |row|
      ...
      statistic.tournament_tier_id = tournament_tier_id
